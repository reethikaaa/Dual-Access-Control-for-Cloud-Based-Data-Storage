...
try 
	{		
				%>
                    <tr>
                      <td width="47" height="30"><div align="center" class="style25"> ID </div></td>
                      <td width="133"><div align="center" class="style25">File Name </div></td>
                      <td width="203"><div align="center" class="style25">Date &amp; Time </div></td>
                      <td width="144"><div align="center" class="style25">Data Owner </div></td>
                    </tr>
                    <%
...
%>
                  ...
                  <div align="right"><a href="C_Main.jsp">Back</a>
                  </div>
                  <p>&nbsp;</p>
                  <p>&nbsp;</p>
                  <p align="justify">&nbsp;</p>
			...
			<ul>
				...
				<li><a href="E_Login.jsp">Encrypter</a></li>
