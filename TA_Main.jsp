        ...
        <div class="tail-right">
          <div class="wrapper">
            <div class="col-1">
              <div class="indent">
                <div class="indent1">
                  <h3>Welcome :: Authority  </h3>
                  <p align="justify">&nbsp;</p>
                  <p align="justify"><img src="images/Authority.jpg" alt="" width="471" height="227" /></p>
                </div>
                <h4>&nbsp;</h4>
              </div>
            </div>
			...
			<ul>
				...
				<li> <a href="TA_Transactions.jsp">View Transactions</a></li>
				<li> <a href="TA_MSKRequests.jsp">View MSK Requests</a></li>
				<li><a href="TA_ViewEndUser.jsp">View End Users</a></li>
