        ...
        <div class="tail-right">
          <div class="wrapper">
            <div class="col-1">
              <div class="indent">
                <div class="indent1">
                  <h3>Welcome Cloud </h3>
                  <p align="justify">&nbsp;</p>
                  <p align="justify"><img src="images/Cloud.jpg" alt="" width="515" height="246" /></p>
                </div>
                <h4>&nbsp;</h4>
              </div>
            </div>
			...
			<ul>
				...
				<li><a href="C_Transactions.jsp">View Transactions</a>  </li>
				<li><a href="C_FileWithMSK.jsp">View Files With MSK </a></li>
				<li><a href="C_MSKTime.jsp">View MSK Req/Res Time</a></li>
				<li> <a href="C_FileWithoutMSK.jsp">View Files Without MSK </a></li>
				<li><a href="C_AuthorizeEndUser.jsp">View and Authorize End User </a></li>
				<li><a href="C_AuthorizeDataOwner.jsp">View and Authorize Data Owner </a></li>
				<li><a href="C_ViewResults.jsp">View Rank Results</a></li>
