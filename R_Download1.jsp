		...
		{	
			...
			if(rs2.next())
			{
				...
				else
				{
					...
					<tr>
					<td width="223" height="35"><span class="style16 style18"><strong>Enter File Name :</strong></span></td>
					<td width="245"><label>
					<input required="required" name="t1" type="text" value="<%=file%>" size="40" />
					</label></td>
					</tr>
					<tr>
					<td height="35"><span class="style16 style18"><strong>Trapdoor :</strong></span></td>
					<td><input name="t12" type="text" value="<%=trapdoor%>" size="40" /></td>
					</tr>
					<tr>
					<td height="35"><span class="style16 style18"><strong>Secret Key :</strong></span></td>
