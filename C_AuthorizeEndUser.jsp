        ...
        <div class="tail-right">
          <div class="wrapper">
            <div class="col-1">
              <div class="indent">
                <div class="indent1">
                  <h3>Authorize End Users </h3>
                  <p align="justify">&nbsp;</p>
                  <table width="500" border="1.5" cellpadding="0" cellspacing="0"  align="center">
                    <tr>
                      <td width="108" height="30"><div align="center" class="style21 style24"><strong> ID </strong></div></td>
                      <td width="183"><div align="center" class="style25"> Name </div></td>
                      <td width="171"><div align="center" class="style25"> Status </div></td>
                      <%	  
