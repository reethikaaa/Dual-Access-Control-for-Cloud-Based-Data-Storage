...
<%
					...
					try {
						...
						//image = image.replace(".", "_b.");
			 			String query1="select * from receiver  where name='"+uname+"'"; 
...
-->
					   ...
					   {
					  PreparedStatement ps=connection.prepareStatement("insert into receiver(name,pass,email,mobile,addr,dob,gender,pin,location,imagess,status) values(?,?,?,?,?,?,?,?,?,?,?)");
